...
int main()
{
    ...
    auto compressione_sc = scarta_per_scarti(scarta_code(compressione));
    auto decompressione_sc = scarta_per_scarti(scarta_code(decompressione));
    auto compressione_conf_sc = scarta_per_scarti(scarta_code(compressione_conf));
    auto decompressione_conf_sc = scarta_per_scarti(scarta_code(decompressione_conf));

    for (int i = 0; i < compressione.size(); i++)
    {
        ofstream fout_compress("../Data_scarti/Dati_comp/" + to_string(i) + ".txt");
    ...
    {
        ofstream fout_decomp("../Data_scarti/Dati_decomp/" + to_string(i) + ".txt");
    ...
    {
        ofstream fout_compress_sc("../Data_scarti/Dati_comp/" + to_string(i) + "_sc.txt");
    ...
    {
        ofstream fout_decomp_sc("../Data_scarti/Dati_decomp/" + to_string(i) + "_sc.txt");
    ...
    {
        ofstream fout_compress_conf_sc("../Data_scarti/Dati_comp/" + to_string(i) + "conf_sc.txt");
    ...
    {
        ofstream fout_decomp_conf_sc("../Data_scarti/Dati_decomp/" + to_string(i) + "conf_sc.txt");
    ...
    ofstream moli_d("../Data_scarti/Dati_moli/moli_decompress.txt");
    for (int i = 0; i < joined_decompress.size(); i++)
    {
        auto &temp = joined_decompress[i];
        moli_d << temp.temp_media << "+/-" << temp.err_temp_media << "\t" << temp.b_ang << "+/-" << temp.err_b_ang << endl;
    }
    ofstream moli_c("../Data_scarti/Dati_moli/moli_compress.txt");
    for (int i = 0; i < joined_compress.size(); i++)
    {
        auto &temp = joined_compress[i];
    ...
    ofstream moli_c_conf("../Data_scarti/Dati_moli/moli_compress_conf.txt");
    for (int i = 0; i < joined_compress_conf.size(); i++)
    {
        auto &temp = joined_compress_conf[i];
        moli_c_conf << temp.temp_media << "+/-" << temp.err_temp_media << "\t" << temp.b_ang << "+/-" << temp.err_b_ang << endl;
    }
    ofstream moli_d_conf("../Data_scarti/Dati_moli/moli_decompress_conf.txt");
    for (int i = 0; i < joined_decompress_conf.size(); i++)
    {
        auto &temp = joined_decompress_conf[i];
 ...
 */
    ...
    */
    ...
    //auto isocora8 = get_isocora("../Data_scarti/isocora.txt");
    //auto isocora21 = get_isocora("../Data_scarti/isocora21.txt");
