...
\begin{figure}[h!]
    ...
    \subfloat[$T_{0}$ in comprensione]{
        \includegraphics[width=8cm]{zero_assoluto_compressione.pdf}
        \label{fig:t0_compr}
    }
    \subfloat[Paraboloide comprensione]{
        \includegraphics[width=8cm]{paraboloide_Compressioni.pdf}
...
\begin{figure}[h!]
    ...
    \subfloat[$T_{0}$ in decompressione]{
        \includegraphics[width=8cm]{zero_assoluto_decompressione.pdf}
        \label{fig:t0_deco}
    }
    \subfloat[Paraboloide decompressione]{
        \includegraphics[width=8cm]{paraboloide_DECompressioni.pdf}
        \label{fig:par_deco}
    }}
\end{figure}
